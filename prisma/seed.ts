...
const items: SeedItem[] = [
  ...
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.VOCAB, scriptText: "家", transliteration: "jia", gloss: "home" },
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.VOCAB, scriptText: "门", transliteration: "men", gloss: "door" },
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.VOCAB, scriptText: "水", transliteration: "shui", gloss: "water" },
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.VOCAB, scriptText: "床", transliteration: "chuang", gloss: "bed" },
  { language: LanguageCode.ZH_HANS, domain: "food", itemType: ItemType.VOCAB, scriptText: "面包", transliteration: "mianbao", gloss: "bread" },
  { language: LanguageCode.ZH_HANS, domain: "food", itemType: ItemType.VOCAB, scriptText: "苹果", transliteration: "pingguo", gloss: "apple" },
  { language: LanguageCode.ZH_HANS, domain: "food", itemType: ItemType.VOCAB, scriptText: "牛奶", transliteration: "niunai", gloss: "milk" },
  { language: LanguageCode.ZH_HANS, domain: "transport", itemType: ItemType.VOCAB, scriptText: "车站", transliteration: "chezhan", gloss: "station" },
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.CHUNK, scriptText: "门在哪里？", transliteration: "men zai nali?", gloss: "where is the door?", patternKey: "zh_location" },
  { language: LanguageCode.ZH_HANS, domain: "home", itemType: ItemType.CHUNK, scriptText: "水在这里", transliteration: "shui zai zheli", gloss: "the water is here", patternKey: "zh_location" },
  { language: LanguageCode.ZH_HANS, domain: "food", itemType: ItemType.CHUNK, scriptText: "我要水", transliteration: "wo yao shui", gloss: "I want water", patternKey: "zh_request" },
  { language: LanguageCode.ZH_HANS, domain: "food", itemType: ItemType.CHUNK, scriptText: "我要面包", transliteration: "wo yao mianbao", gloss: "I want bread", patternKey: "zh_request" },
  { language: LanguageCode.ZH_HANS, domain: "transport", itemType: ItemType.CHUNK, scriptText: "车站在哪里？", transliteration: "chezhan zai nali?", gloss: "where is the station?", patternKey: "zh_location" },
  { language: LanguageCode.ZH_HANS, domain: "health", itemType: ItemType.CHUNK, scriptText: "我很累", transliteration: "wo hen lei", gloss: "I am tired" },
  { language: LanguageCode.ZH_HANS, domain: "emergencies", itemType: ItemType.CHUNK, scriptText: "帮帮我", transliteration: "bang bang wo", gloss: "help me" },
];
